...
| 店舗一覧ページ表示 | GET | /shops | shops#index |
| 店舗詳細ページ表示 | GET | /shops/:slug | shops#show |
| 店舗登録ページ表示 | GET | /business/shops/new | business/shops#new |
| 店舗登録処理 | POST | /business/shops | business/shops#create |
| （経営者のみ）店舗編集ページ表示 | GET | /business/shops/:slug/edit | business/shops#edit |
| （経営者のみ）店舗更新処理 | PATCH、PUT | /business/shops | business/shops#update |
| 店舗の投稿一覧ページ表示 | GET | /shops/:slug/posts | shops/posts#index |
| 店舗の投稿詳細ページ表示 | GET | /shops/:slug/posts/:id | shops/posts#show |
| （経営者のみ）店舗の投稿登録ページ表示 | GET | /business/shops/:slug/posts/new | business/shops/posts#new |
| （経営者のみ）店舗の投稿登録処理 | POST | /business/shops/:slug/posts | business/shops/posts#create |
| （経営者のみ）店舗の投稿編集ページ表示 | GET | /business/shops/:slug/posts/:id/edit | business/shops/posts#edit |
| （経営者のみ）店舗の投稿更新処理 | PATCH、PUT | /business/shops/:slug/posts/:id | business/shops/posts#update |
| （経営者のみ）店舗の投稿削除処理 | DELETE | /business/shops/:slug/posts/:id | business/shops/posts#destroy |
| お気入りに店舗登録 | POST | /shops/:slug/favorite | shops/favorites#create |
| お気入りから店舗削除 | DELETE | /shops/:slug/favorite | shops/favorites#destroy |
